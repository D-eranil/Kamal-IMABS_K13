...
{
	/// <summary>
	/// Provides methods for retrieving pages of type Footer.
	/// </summary>
	public partial class FooterProvider
	{
		/// <summary>
		/// Returns a query that selects published pages of type Footer.
		/// </summary>
		public static DocumentQuery<Footer> GetFooters()
		{
			return DocumentHelper.GetDocuments<Footer>().PublishedVersion().Published();
		}
		...
		public static DocumentQuery<Footer> GetFooter(int nodeId, string cultureName, string siteName)
		{
			return GetFooters().OnSite(siteName).Culture(cultureName).WhereEquals("NodeID", nodeId);
		}
		...
		/// <param name="siteName">The name of the site where the page belongs.</param>
		/// <param name="cultureName">The name of the language, e.g. en-US, that determines which localized version should be retrieved.</param>
		public static DocumentQuery<Footer> GetFooter(Guid nodeGuid, string cultureName, string siteName)
		{
			return GetFooters().OnSite(siteName).Culture(cultureName).WhereEquals("NodeGUID", nodeGuid);
		}
